        ...
        <main class="content">
            ...
            <div class="reservation">
                <div class="reservation-box">
                    ...
                    <form action="/done" method="post" class="reservation-form">
                        @csrf
                        ...
                        <div class="confirm">
                            <table class="confirm-table">
                                <tr class="confirm-table__row">
                                    ...
                                    <td class="confirm-form__data">{{ $shop->name }}</td>
                                    <input type="hidden" name="shop_id" value="{{ $reservation['shop_id'] }}">
                                </tr>
                                <tr class="confirm-table__row">
                                    <th class="confirm-form__label">Date</th>
                                    <td class="confirm-form__data">{{ $reservation['date'] }}</td>
                                    <input type="hidden" name="date" value="{{ $reservation['date'] }}">
                                </tr>
                                <tr class="confirm-table__row">
                                    <th class="confirm-form__label">Time</th>
                                    <td class="confirm-form__data">{{ $reservation['time'] }}</td>
                                    <input type="hidden" name="time" value="{{ $reservation['time'] }}">
                                </tr>
                                <tr class="confirm-table__row">
                                    <th class="confirm-form__label">Number</th>
                                    <td class="confirm-form__data">{{ $reservation['num_of_users'] }}人</td>
                                    <input type="hidden" name="num_of_users" value="{{ $reservation['num_of_users'] }}">
                                </tr>
                            </table>
                        </div>
                        <div class="alert-success">この内容で予約しますか？</div>
